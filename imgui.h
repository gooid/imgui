...
static inline void ImDrawCmdUserCall(const ImDrawList* parent_list, const ImDrawCmd* cmd) { 
...
#endif
const int ImDrawIdxSize = sizeof(ImDrawIdx);
...
const int ImDrawVertSize = sizeof(ImDrawVert);
static inline void ImDrawVertOffset(int* pos_offset, int* uv_offset, int* col_offset) {
    *pos_offset = IM_OFFSETOF(ImDrawVert, pos);
    *uv_offset = IM_OFFSETOF(ImDrawVert, uv);
    *col_offset = IM_OFFSETOF(ImDrawVert, col);
}
...
#endif /* SWIG */
    IMGUI_API size_t  CommandsSize() { return CmdBuffer.size(); }
    IMGUI_API ImDrawCmd* CommandsAt(size_t i) { return &CmdBuffer[i]; }
    IMGUI_API size_t  VtxBufferSize() { return VtxBuffer.size(); }
    IMGUI_API ImDrawVert* VtxBufferAt(size_t i) { return &VtxBuffer[i]; }
    IMGUI_API size_t  IdxBufferSize() { return IdxBuffer.size(); }
    IMGUI_API ImDrawIdx* IdxBufferAt(size_t i) { return &IdxBuffer[i]; }
};
